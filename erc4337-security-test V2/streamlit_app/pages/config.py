...
def render() -> None:
    ...
    ai_output = st.text_input("默认 AI 原始输出路径", value=cfg.get("ai_dataset_output", "ai-attack-generator/attacks_dataset_500.json"))
    ai_clean_output = st.text_input("默认 AI Clean 输出路径", value=cfg.get("ai_clean_dataset_output", "ai-attack-generator/attacks_dataset_1200_clean.json"))
